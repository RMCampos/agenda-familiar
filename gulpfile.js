...
gulp.task('watch', () => {
    browserSync.init({proxy: 'localhost:5005',});
...
gulp.task('copy-js', () => gulp.src(['src/main/resources/**/*.js']).pipe(babel({presets: ['@babel/preset-env'] })).pipe(gulp.dest('target/classes/')));
